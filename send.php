<meta http-equiv='refresh' content='3; https://tollerto.github.io/Educ/'>
<meta charset="UTF-8" />
<?php
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Сообщение отправлено успешно! Перейти на <a href='https://tollerto.github.io/Educ/'>website page</a>, если вас не перенаправило вручную.";
	else
